...
# Override with in protobuf-gen -> service-prefixes (Accepts a list)
_PROTOBUF_GEN_SERVICE_PREFIXES_DEFAULT = []
...
class ProtobufGen(CodeGen):
  ...
  def register_options(cls, register):
    ...
    register('--service-prefixes', advanced=True, action='append',
             help='Prefixes for services generated by custom plugins. This is needed for source/jar '
                  'mapping and invalidation.',
             default=_PROTOBUF_GEN_SERVICE_PREFIXES_DEFAULT)
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.service_prefixes = self.get_options().service_prefixes
